...
<html lang="en">
  <head>
    ...
    <title>二维码活动列表-<?php echo $orgname; ?></title>
                      ...
                      <section class="panel">
                                  ...
                                  <div>
                                      ...
                                      <div class="text-center">
										...
										?>
                                          ...
                                          <a href="qr_new_show.php?actcode=<?php echo base64_encode($actid); ?>#qr" class="view-all" target="_blank">出示二维码</a>
                                          <!--<a href="qr_show.php?actcode=<?php echo base64_encode($actid); ?>" class="view-all" target="_blank">旧版签到</a>-->
                          ...
                          <div class="panel-body">
                              <ul class="ft-link">
                                  <li>
                                     <?php if($row_sub[4]=="on"){?>
                                      <a href="app/qr_close.php?actid=<?php echo base64_encode($actid); ?>">
                                  ...
                                  <li>
                                      <a href="qr_sign_record.php?actid=<?php echo base64_encode($actid); ?>" target="_blank">
                                          <i class=" icon-calendar-empty"></i>
                                          记录
                                      </a>
                                  </li>
                                  <li>
                                      <a href="qr_card_provide.php?actid=<?php echo base64_encode($actid); ?>" target="_blank">
                                          <i class="fa fa-ticket"></i>
                                          发券
                                      </a>
                                  </li>
                                  <li>
                                      <a href="app/qr_delete.php?actid=<?php echo base64_encode($actid); ?>">
