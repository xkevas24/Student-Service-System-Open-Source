                      ...
                      <section class="panel">
                          <table class="table table-hover personal-task">
                              <tbody>
                               <?php
								  //查看是否注册了商铺
								  $if_shop=mysqli_fetch_row(mysqli_query($con,"select id from stu_ishop where shopmaster='$sn' and shopstatus='正常';"))[0];
								  if($if_shop<>""){
									  $menu_sql="select * from stu_shoplist where id!=1;";
								  }else{
									  $menu_sql="select * from stu_shoplist where id='1';";
								  }
