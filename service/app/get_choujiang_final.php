...
$cardid=str_rand();
//检查今日是否领取过
$sql="select id from stu_choujiang where poststuno='$sn' and gettype='final';";
...
$cardid_check=mysqli_fetch_row(mysqli_query($con,$sql))[0];
if($cardid<>""){
$sql="insert into stu_choujiang (id,cardid,poststuno,gettime,gettype,get_date) values (null,'$cardid','$sn','$time','final','$date')";
