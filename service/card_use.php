              ...
              <div class="row">
                  <div class="col-lg-4">
                      ...
                      <section class="panel"><br>
						  ...
						  ?>
                          <img id="qrcode" src="app/xf_cardcode.php?var=<?php echo $val; ?>" width="100%">
                          <div align="center">
                          	<button id="refresh" class="btn btn-info" onClick="qr_refresh();refresh_click();">刷新二维码</button>
                          </div>
                          <hr>
                          <div align="center">
                          	<p><?php echo $name."(".$sn.")"; ?></p>
                          	<br>
                          </div>
...
<script>
 function qr_refresh(){
   document.getElementById("qrcode").src='app/xf_cardcode.php?var=<?php echo $val; ?>';
 }
