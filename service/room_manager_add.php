                  ...
                  <div class="col-lg-8">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                             ...
                             <hr>
                             <br>
                              <form class="form-horizontal" role="form" method="post" action="app/room_manager_add.php">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          ...
                                          <p class="help-block">输入审批人姓名</p>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="name" class="col-lg-2 control-label">学号</label>
                                      <div class="col-lg-10">
                                          <input type="number" style="color: black" class="form-control" name="sn" required>
                                          <p class="help-block">输入审批人学号</p>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="name" class="col-lg-2 control-label">手机</label>
                                      <div class="col-lg-10">
                                          <input type="tel" style="color: black" class="form-control" name="phone" required>
                                          <p class="help-block">输入审批人联系手机</p>
                                      </div>
                                  </div>
