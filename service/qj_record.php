              ...
              <section class="panel">
                          ...
                          <div class="table-responsive">
                             ...
                             <caption>所有已通过的请假条</caption>
                              ...
                              <tbody>
                              <?php 
                              $list_sql="select * from dsu_qingjia where orgname='$orgname' and state='通过' order by subdate desc;";
								  $sign_result=mysqli_query($con_db2,$list_sql);
