...
<html lang="en">
  <head>
    ...
    <title>假勤管理系统-<?php echo $orgname; ?></title>
                  ...
                  <div class="col-lg-4">
                      ...
                      <section class="panel">
                          <table class="table table-hover personal-task">
                              <tbody>
                               <?php
								 $menu_result=mysqli_query($con,"select * from stu_attlist;");
								 while($menu=mysqli_fetch_row($menu_result)){
									 $auth_level=$menu[4];
									 if($suauth==1 && $auth_level==2){
								 ?>
                                <tr onClick="window.open('<?php echo $menu[2]; ?>')">
                                   
                                    <td>
                                        <i class="fa fa-<?php echo $menu[3]; ?>"></i>
                                    </td>
