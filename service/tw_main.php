...
$orgsql = "select * from stu_sucache where xm='$name' and xh='$sn' and org='院团委' and dep='$depname' and state='正常';";
...
$mod_sql="select smod from stu_twlist where id='$lid';";
...
//订阅开通
$func_sql="select subscribes from stu_twlist where id='$lid';";
...
<html lang="en">
  <head>
    ...
    <title><?php echo "校团委".$depname; ?></title>
                  ...
                  <div class="col-lg-6">
                              ...
                              <section class="panel">
                                  <div class="twt-feed blue-bg">
                                      <h1><?php echo $depname; ?></h1>
                                      <p>官方认证号：<?php echo $hint; ?></p>
                                      <a href="#">
                                          <img src="img/orglogo/ytw.png" width="140px" alt="">
                                      </a>
                                  </div>
                                  <div class="weather-category twt-category">
                                      <ul>
                                          ...
                                          <li>
                                              <h5><?php echo mysqli_fetch_row(mysqli_query($con,"select count(id) from stu_sucache where org='$orgname' and dep='$depname' and state='正常';"))[0]; ?></h5>
                                              组织成员
                                          </li>
                                          <li>
                                  ...
                                  <?php }else{ ?>
                                  <blockquote>该部门暂未开通订阅功能。<br></blockquote>
                                  <?php } ?>
                                  <footer class="twt-footer">
                                    ...
                                    <?php 
									  ...
									  ?>
                                      <?php if($sub_status<>"1"){ ?>
                                      <button class="btn btn-space btn-info pull-right" type="button" onClick="location='app/subscribe_tw.php?did=<?php echo $did; ?>'">
                                          <i class="fa fa-bell"></i>
                                          关注
                                      </button>
                                      <?php }else{ ?>
                                      <button class="btn btn-space btn-danger pull-right" type="button" onClick="location='app/dissubscribe_tw.php?did=<?php echo $did; ?>'">
                                          <i class="fa fa-bell"></i>
                                          取关
                                      </button>
                                      <?php } ?>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              长按保存二维码，分享主页...
                                              <img src="app/qrcode.php?var=000023&actcode=<?php echo $did; ?>" width="100%" alt="分享">
                                ...
                                <?php
								 ...
								 ?>
                                  <div class="msg-time-chat">
                                      <a href="#" class="message-img"><img class="avatar" src="img/orglogo/ytw.png" width="45px" alt=""></a>
