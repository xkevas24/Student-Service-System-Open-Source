                             ...
                             <caption>已选定的本期有效活动</caption>
                              ...
                              <?php 
								...
								$list_sql="select * from stu_erkeku where eid='".implode("' or eid='",$yx_eid)."';";
								  ...
								  while($sign=mysqli_fetch_row($list_result)){
								?>
                              <tr>
                                  ...
                                  <td>
                              <a href="app/sec_yx_cancel.php?eid=<?php echo $sign[0]; ?>" class="btn btn-xs btn-danger">
                                  撤销
                              </a></td>
                          ...
                          <div class="table-responsive">
                             ...
                             <caption>所有第二课堂活动</caption>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $sign[5]; ?></td>
                                  <td><?php echo $sign[6]; ?></td>	
                                  <td><a href="app/sec_yx_set.php?eid=<?php echo $sign[0]; ?>" class="btn btn-xs btn-success">
                                  设置为有效
                              </a></td>							
                              </tr>
                              <?php } ?>
