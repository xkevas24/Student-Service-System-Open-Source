...
$mod_sql="select smod from stu_stulist where id='$lid';";
$mod_result=mysqli_query($con,$mod_sql);
$mod=mysqli_fetch_row($mod_result)[0];
$mod=explode("@",$mod);
$mod_num=count($mod);
//获取关注情况
$sub_sql="select status from stu_subscribes where oid='$oid' and sn='$sn';";
$sub_status=mysqli_fetch_row(mysqli_query($con,$sub_sql))[0];
//订阅数
$subscribes=mysqli_fetch_row(mysqli_query($con,"select count(id) from stu_subscribes where status='1' and oid='$oid';"))[0];
//订阅开通
$func_sql="select subscribes from stu_stulist where id='$lid';";
                              ...
                              <section class="panel">
                                  ...
                                  <div class="weather-category twt-category">
                                      <ul>
                                          ...
                                          <li>
                                              <h5><?php if($sub_func=="on"){ echo $subscribes; }else{ echo "未开通"; echo $sub_func; } ?></h5>
                                              关注
                                          </li>
                                      </ul>
                                  </div>
                                  ...
                                  <?php }else{ ?>
                                  <blockquote>该组织暂未开通订阅功能。<br></blockquote>
                                  <?php } ?>
                                  <footer class="twt-footer">
                                     ...
                                     <a class="btn btn-space btn-white" data-toggle="modal" href="#myModal3">
									  ...
									  ?>
                                      <?php if($sub_status<>"1"){ ?>
                                      <button class="btn btn-space btn-info pull-right" type="button" onClick="location='app/subscribe.php?oid=<?php echo $oid; ?>'">
                                          <i class="fa fa-bell"></i>
                                          关注
                                      </button>
                                      <?php }else{ ?>
                                      <button class="btn btn-space btn-danger pull-right" type="button" onClick="location='app/dissubscribe.php?oid=<?php echo $oid; ?>'">
                                          <i class="fa fa-bell"></i>
                                          取关
                                      </button>
                                      <?php } ?>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              长按保存二维码，分享主页...
                                              <img src="app/qrcode.php?var=000022&actcode=<?php echo $oid; ?>" width="100%" alt="分享">
