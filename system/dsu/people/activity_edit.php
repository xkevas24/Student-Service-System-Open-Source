...
<head>
<meta charset="utf-8">
<title>发布活动-<?php echo $org; ?>-学生服务系统</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form method="post" action="controller/activity_pub.php">
<div class="body">
<div class="col-md-12">
<div class="form-group">
  <div class="form-line">
  <input name="title" type="text" class="form-control" value="" placeholder="文章标题" required />
 </div>
 </div>
</div>
<div class="col-md-12">
...
<div class="col-md-4">
<image src="" id="show_image" class="img-polaroid"/>
	<textarea id="base64_output" name="picsrc"  placeholder="这里输出base64码" class="form-control invisible" rows="5"></textarea>
</div>
</div>	
</div>
...
<button id="box" type="submit" class="btn btn-success waves-effect">发布</button>
						</div>
...
var showArea = function(){
	...
	Gid('sel').innerHTML = "<h3>省" + Gid('s_province').value + " - 市" + 	
...
function gen_base64() {
                ...
                r.onload = function(){
                    ...
                    $_('show_image').style="height:280px;";
                }
...
function gen_base64_2() {
                ...
                r.onload = function(){
                    ...
                    $_('show_image_2').style="height:280px;";
                }
                r.readAsDataURL(file);    //Base64
            }
