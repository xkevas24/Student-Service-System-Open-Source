...
?>
    ...
    <title>短期封禁-<?php echo $org; ?>-学生服务系统</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
								<?php
								$get_member="select xm,sex,xh,dep,job,ps,state,id,bantil from stu_sucache where org='$org' and state='短封禁';";
                            ...
                            <div class="table-responsive">
								...
								?>
									...
									if($member_row[6]=="正常"){
									 ...
									 ?></td>
									<td>
										<a href="short_ban_set.php?id=<?php echo $member_row[7]; ?>" onclick="if(confirm('确认封禁：<?php echo $member_row[0]; ?>吗？')==false)return false;" ><font color='#AF0002'><em class="fa fa-close"></em>短封禁</font></a>
