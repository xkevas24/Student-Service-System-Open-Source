...
?>
    ...
    <title>成员删除-<?php echo $org; ?>-学生服务系统</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    成员删除
                    <small>符合下列条件之一者，应由系统管理方将其从系统中删除：1、自然退出组织的；2、被勒令退出组织的；3、屡次违反系统规定的</small>
                </h2>
            </div>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
								<?php
								$get_member="select xm,sex,xh,dep,job,ps,state,id from stu_sucache where org='$org';";
								...
								?>
									...
									if($member_row[6]=="正常"){
									 ...
									 ?></td>
									<td>
										<a href="controller/member_delete.php?id=<?php echo $member_row[7]; ?>" onclick="if(confirm('确认要删除成员：<?php echo $member_row[0]; ?>吗？')==false)return false;" ><font color='#AF0002'><em class="fa fa-trash"></em>删除</font></a>
